...
class UIFunctions(MainWindow):
    ...
    def on_button_click(self):
        sender = self.sender()  # Xác định nút gửi sự kiện

        # Đặt màu nền của tất cả các nút thành trắng
        for button in self.buttons:
            button.setStyleSheet("background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);font: 650 14px;")

        # Đặt màu nền của nút đang được nhấn thành màu xanh nhạt
        sender.setStyleSheet("background-color: rgb(173, 216, 230);color: rgb(0, 0, 0);font: 650 14px;")

        # Kích hoạt nút đang được nhấn
